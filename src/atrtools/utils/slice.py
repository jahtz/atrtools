...
class SliceUtils:
    ...
    def aspect(a: tuple[slice, ...]) -> float:
        ...
        return SliceUtils.height(a) * 1.0 / SliceUtils.width(a)
    ...
    def empty(a: tuple[slice, ...]) -> bool:
        ...
        return a is None or SliceUtils.volume(a) == 0
    ...
    def xoverlap_rel(u: tuple[slice, ...], v: tuple[slice, ...]) -> float:
        ...
        return SliceUtils.xoverlap(u, v) * 1.0 / max(1, SliceUtils.width(u), SliceUtils.width(v))
